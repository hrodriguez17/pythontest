...
def get_map():
    with st.spinner('Visuals...'):
        ...
        vectorizer = TfidfVectorizer(lowercase=True, max_features=10000, max_df=0.1, min_df=1,
        ...
        colors = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22",
                  "#17becf", "#F0F8FF", "#FAEBD7", "#00FFFF", "#7FFFD4", "#F0FFFF", "#F5F5DC", "#FFE4C4", "#000000",
                  "#FFEBCD", "#0000FF", "#8A2BE2", "#A52A2A", "#DEB887", "#5F9EA0", "#7e1e9c", "#7FFF00", "#D2691E",
                  "#FFF8DC", "#DC143C", "#00008B", "#B8860B", "#A9A9A9", "#006400", "#BDB76B", "#8B008B", "#556B2F",
